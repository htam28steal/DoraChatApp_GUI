    ...
    <View style={styles.container}>
      ...
      <View style={styles.fDetail}>
        <View style={styles.fRow}>
          ...
          <Text style={styles.txtMT}>Her information</Text>
        </View>
        ...
        <View style={styles.fDetailInfor}>
          <View style={styles.f}>
            <View style={styles.fRowS}>
              <Image
                source={require('../icons/cake.png')}
                style={styles.iconDe}></Image>
              <Text>Date of birth: January 25, 2003</Text>
            </View>
            <View style={styles.fRowS}>
              <Image
                source={require('../icons/dog.png')}
                style={styles.iconDe}></Image>
              <Text>Join at: November 11, 2003</Text>
            </View>
            <View style={styles.fRowS}>
              <Image
                source={require('../icons/house.png')}
                style={styles.iconDe}></Image>
              <Text>Live at: Hồ Chí Minh City</Text>
            </View>
          </View>
        </View>
        <View style={styles.fRow}>
        ...
        <View style={styles.fHobbies}>
          <View style={styles.fHobbie}>
            <Text style={styles.txtHobbies}>⚽ Football</Text>
          </View>
          <View style={styles.fHobbie}>
            <Text style={styles.txtHobbies}>🏸Bamintion</Text>
          </View>
          <View style={styles.fHobbie}>
            <Text style={styles.txtHobbies}>📸 Photograph</Text>
          </View>
          <View style={styles.fHobbie}>
            <Text style={styles.txtHobbies}>🎤 Singing</Text>
          </View>
        </View>
      </View>
    </View>
